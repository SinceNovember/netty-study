    ...
    private static void startSendMsgThread(Channel channel) {
        new Thread(()->{
            ...
            while (true){
                ...
                //发送创建群信息
                System.out.println("发送创建群信息");
                CreateGroupRequestPacket createGroupRequestPacket = new CreateGroupRequestPacket();
                createGroupRequestPacket.setGroupName("1234");
                createGroupRequestPacket.setGroupLeader(23L);
                createGroupRequestPacket.setUserIdList(Arrays.asList(123L));
